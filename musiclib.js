...
function Playlist(playlist, tracks) {
    this.playlist = playlist;
    this.tracks = tracks;
...
let track2 = new Track("I am bored", 4, 154);
let track3 = new Track("Where am I", 2, 134);
let track4 = new Track("Where am I", 2, 134);
let track5 = new Track("Where am I", 2, 134);
let track6 = new Track("Where am I", 2, 134);
